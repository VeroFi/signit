            ...
            <div className="md:p-4 lg:p-10 p-4 bg-base-100 text-base-content op-card">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-2">
                <div>
                  ...
                  {/* VerifyID SSO Login */}
                  {process.env.REACT_APP_VERIFYID_URL && (
                    <div className="mt-6">
                      <div className="relative">
                      ...
                      <div className="mt-4">
                        <a
                          href={`${process.env.REACT_APP_VERIFYID_URL}/auth/signit-redirect`}
                          className="w-full inline-flex justify-center items-center gap-2 op-btn op-btn-outline op-btn-secondary text-xs font-bold"
                        >
                          <svg
                            className="w-5 h-5"
                            viewBox="0 0 24 24"
