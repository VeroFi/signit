import { convertPdfToNewPdf, getSecureUrl } from '../../Utils.js';
    ...
    if (request.user) {
      ...
      if (resExt) {
        ...
        if (ext === 'pdf') {
          ...
          // Convert PDF to a new PDF (rewrites it for Textract compatibility)
          const newPdf = await convertPdfToNewPdf(fileBase64);
          file = [...newPdf];
